...
export const GPT_IMAGE_2_TEMPLATE_SOURCE = {
  repository: 'https://github.com/freestylefly/awesome-gpt-image-2',
  commit: '10631618972cca3c1aead9d2530216f0a17c8994',
  license: 'MIT',
}

export const GPT_IMAGE_2_TEMPLATE_CATEGORIES: PromptTemplateCategory[] = [
  {
    "id": "ui",
    "label": "UI 与界面"
  },
...
export const GPT_IMAGE_2_TEMPLATES: PromptTemplate[] = [
  {
    "id": "ui-general",
    "title": "UI 与界面常规模板",
    "categoryId": "ui",
    ...
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-ui"
  },
  {
    "id": "ui-json",
    ...
    "promptType": "json",
    "description": "UI 与界面结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "截图生成提示词模板。",
    "prompt": "生成一张[平台，如 X/抖音/小红书/微信朋友圈]内容截图，[深色/浅色]模式。\n整体比例：[9:16 / 3:4 / 1:1]，手机截图风格。\n\n核心内容：\n- 账号信息：[头像描述 / 用户名 / 认证标识]\n- 正文内容：[具体文本内容，包含指定中文]\n- 互动数据：[点赞/评论/转发/收藏数量]\n\n界面元素：\n- 顶部：[状态栏/导航栏/搜索栏]\n- 底部：[操作栏/Tab栏/输入框]\n- 附加：[浮窗/弹幕/礼物特效/购物车卡片]\n\n约束：文字必须准确显示指定的中文，禁止乱码和占位文本，比例固定。\n输出：高仿社交平台截图，文字清晰可读。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-ui"
  },
  {
    "id": "ui-live",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "图表与信息可视化基础提示词模板。",
    "prompt": "生成[主题：明确、具体，避免宽泛。例如：“老年人日常健康管理指南”而非“健康”]信息图，目标读者为[人群:细化人群特征，如年龄段、职业、兴趣等]。\n结构：标题区 + [3-5]个模块（每模块含图标、短标题、1-2句说明,模块间逻辑：可用箭头、颜色区分或连接线提示信息流或关系等适当的方式）。\n图表类型：[流程图/对比图/关系图/时间线]。\n风格：[专业报告/科普插画/儿童教育等]，主色[颜色]，背景[浅色/深色]。\n输出：信息层级清晰、可读性高的中文信息图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-infographic"
  },
  {
    "id": "infographic-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    ...
    "promptType": "json",
    "description": "图表与信息可视化结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "海报与排版基础提示词模板。",
    "prompt": "设计一张[活动/产品/电影]海报，主题为[主题词]。\n主视觉：[主体元素]，标题文案：[标题]，副标题：[副标题]。\n版式：[居中/左对齐/对角构图]，风格：[复古/未来/极简]。\n色彩：[主色 + 辅色]，氛围：[情绪关键词]。\n输出：可用于社媒传播的高分辨率海报。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-poster"
  },
  {
    "id": "poster-sports-campaign",
    "title": "运动商业 Campaign ",
    "categoryId": "poster",
    "tags": [
      "海报",
    ...
    "promptType": "text",
    "description": "运动商业 Campaign 提示词模板。",
  ...
  {
    "id": "poster-conceptual-typography",
    "title": "概念字体海报",
    "categoryId": "poster",
    "tags": [
      "海报",
  ...
  },
  {
    ...
    "promptType": "json",
    "description": "海报与排版结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "商品与电商基础提示词模板。",
    "prompt": "生成[商品名]电商主图，卖点为[卖点1]、[卖点2]。\n场景：[纯色棚拍/生活方式场景]，镜头：[特写/半身/全景]。\n材质细节：[材质关键词]，灯光：[柔光/侧光/轮廓光]。\n附加元素：[价格角标/卖点icon/促销文案]。\n输出：电商平台可直接使用的商品展示图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-product"
  },
  {
    "id": "product-beauty-report",
    "title": "个人化美妆推荐报告",
    "categoryId": "product",
    "tags": [
      "商品",
  ...
  },
  {
    ...
    "promptType": "json",
    "description": "商品与电商结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "品牌与标志基础提示词模板。",
    "prompt": "为[品牌名]设计品牌视觉方案。\n品牌关键词：[关键词1]、[关键词2]、[关键词3]。\n包含：Logo方向[几何/字标/图形]、辅助图形、主辅色、应用示意。\n风格：[现代/高级/亲和]，行业：[行业]，受众：[受众]。\n输出：统一风格的品牌识别视觉图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-brand"
  },
  {
  ...
  },
  {
    ...
    "promptType": "json",
    "description": "品牌与标志结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "建筑与空间基础提示词模板。",
    "prompt": "生成[空间类型]设计效果图，功能定位为[用途]。\n风格：[现代简约/工业/新中式]，材质：[木/石/金属/玻璃]。\n空间结构：[开敞/分区]，动线：[主通道说明]。\n光线：[自然采光/人工照明方案]，时间：[白天/夜景]。\n输出：写实建筑空间渲染图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-architecture"
  },
  {
    ...
    "promptType": "json",
    "description": "建筑与空间结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "摄影与写实基础提示词模板。",
    "prompt": "拍摄主题：[人物/物品/街景]，场景为[地点]。\n摄影参数风格：[35mm/85mm]，[浅景深/深景深]，[纪实/电影感]。\n光线：[自然光/夜景霓虹/逆光]，情绪：[情绪词]。\n细节要求：[肤质/材质/颗粒感]。\n输出：高写实摄影风格图像。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-photo"
  },
  {
    "id": "photo-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    ...
    "promptType": "json",
    "description": "摄影与写实结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "插画与艺术基础提示词模板。",
    "prompt": "创作[题材]插画，主角为[角色/主体]。\n画风：[日漫/水彩/扁平/厚涂]，线条：[细腻/粗犷]。\n配色：[配色方案]，背景：[简洁/复杂场景]。\n构图：[近景/中景/远景]，重点表现[细节]。\n输出：可用于封面或社媒发布的高质量插画。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-illustration"
  },
  {
    "id": "illustration-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    "categoryId": "illustration",
    "tags": [
      "插画",
    ...
    "promptType": "json",
    "description": "插画与艺术结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "人物与角色基础提示词模板。",
    "prompt": "设计[角色身份]角色设定图。\n外观：[年龄/发型/服饰/配件]，性格：[关键词]。\n姿态：[站姿/动态动作]，表情：[情绪]。\n世界观：[时代/阵营/职业]，标志性元素：[元素]。\n输出：角色主视图 + 风格统一的人设图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-character"
  },
  {
    "id": "character-action-sheet",
    "title": "动作分解参考表",
    "categoryId": "character",
    "tags": [
      "角色",
  ...
  },
  {
    ...
    "promptType": "json",
    "description": "人物与角色结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "场景与叙事基础提示词模板。",
    "prompt": "生成[故事主题]场景图，发生在[时间+地点]。\n主事件：[事件描述]，主角：[角色]，冲突点：[冲突]。\n镜头语言：[广角建立镜头/中景叙事/特写]。\n氛围：[紧张/温暖/悬疑]，色调：[冷/暖/高反差]。\n输出：具备叙事张力的场景概念图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-scene"
  },
  {
    "id": "scene-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    ...
    "promptType": "json",
    "description": "场景与叙事结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "历史与古风基础提示词模板。",
    "prompt": "生成[朝代/古风设定]题材画面，主题为[主题]。\n人物：[身份/服饰/器物]，场景：[宫廷/市井/山水]。\n美术风格：[工笔/写意/影视写实]，色调：[色调]。\n文化细节：[纹样/礼制/建筑要素]。\n输出：历史氛围准确的古风题材图。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-history"
  },
  {
    "id": "history-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    ...
    "promptType": "json",
    "description": "历史与古风结构化 JSON 提示词模板。",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "文档与出版物基础提示词模板。",
    "prompt": "制作[文档类型，如菜单/杂志内页/报纸版式]。\n版面结构：[栏数/页边距/标题层级]。\n内容模块：[封面区/正文区/图表区/脚注]。\n字体风格：[衬线/无衬线]，配色：[配色方案]。\n输出：可读性强、版式规范的出版物视觉稿。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-document"
  },
  {
    "id": "document-json",
    "title": "JSON 进阶模板（推荐给 Agent 调用）",
    ...
    "promptType": "json",
    "description": "文档与出版物结构化 JSON 提示词模板。",
  ...
  {
    "id": "document-corporate-brochure",
    "title": "企业画册系统",
    "categoryId": "document",
    "tags": [
      "文档",
  ...
  },
  {
    ...
    "promptType": "text",
    "description": "其他应用基础提示词模板。",
    "prompt": "任务目标：[你要生成的内容类型]。\n输入约束：主体[主体]，场景[场景]，风格[风格]，色彩[配色]。\n质量约束：清晰度[高清/4K]，比例[比例]，构图[构图方式]。\n输出约束：用于[用途]，需突出[核心信息]。\n请输出一版主方案 + 一版备选方案。",
    "sourceUrl": "https://github.com/freestylefly/awesome-gpt-image-2/blob/10631618972cca3c1aead9d2530216f0a17c8994/docs/templates.md#tpl-other"
  },
  {
    "id": "other-concept-product-breakdown",
    "title": "概念产品研发拆解板",
    "categoryId": "other",
    "tags": [
      "通用",
  ...
  },
  {
    ...
    "promptType": "json",
    "description": "其他应用结构化 JSON 提示词模板。",
